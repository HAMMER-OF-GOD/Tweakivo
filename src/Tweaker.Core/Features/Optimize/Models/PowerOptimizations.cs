...
{
    public const string TweakivoPowerPlanGuid = "57696e68-616e-6365-506f-776572000000";
    public const string TweakivoPowerPlanName = "Tweakivo Power Plan";
    public const string LegacyTweakerPowerPlanName = "Tweaker Power Plan";

    public static bool IsTweakivoPowerPlanGuid(string? guid) =>
        string.Equals(guid?.Trim(), TweakivoPowerPlanGuid, StringComparison.OrdinalIgnoreCase);

    public static bool IsTweakivoPowerPlanName(string? name) =>
        string.Equals(name?.Trim(), TweakivoPowerPlanName, StringComparison.OrdinalIgnoreCase) ||
    ...
    public static readonly List<PredefinedPowerPlan> BuiltInPowerPlans = new List<PredefinedPowerPlan>
    {
        ...
        new(TweakivoPowerPlanName, "Optimized power plan for gaming and performance", "PowerPlan_TweakerPowerPlan_Name", TweakivoPowerPlanGuid)
    };
}
