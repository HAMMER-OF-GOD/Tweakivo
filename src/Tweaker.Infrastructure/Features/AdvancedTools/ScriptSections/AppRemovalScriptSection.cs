...
internal class AppRemovalScriptSection
{
    ...
    {
        sb.AppendLine($"{indent}# Create desktop shortcut for Tweakivo installer");
        sb.AppendLine($"{indent}try {{");
        sb.AppendLine($"{indent}    $shortcutPath = \"C:\\Users\\Default\\Desktop\\Install Tweakivo.lnk\"");
        ...
        sb.AppendLine($"{indent}    $shortcut.Description = \"Download and install Tweakivo\"");
