...
internal static class ScriptPreambleSection
{
    public static void AppendHeader(StringBuilder sb)
    {
        sb.AppendLine($@"<#
.SYNOPSIS
    Tweakivo Windows 10/11 Customization and Optimization Script
.DESCRIPTION
...
# Initialize log file
Write-Log ""================================================================================="" ""INFO""
Write-Log ""Tweakivo Windows Optimization & Customization Script Started"" ""INFO""
...
");
    ...
    public static void AppendCompletionBlock(StringBuilder sb)
    {
        ...
        sb.AppendLine("Write-Log \"Tweakivo Windows Optimization & Customization Script Completed\" \"SUCCESS\"");
        sb.AppendLine("Write-Log \"================================================================================\" \"INFO\"");
    }
}
