...
public class VersionService : IVersionService
{
    ...
    private readonly string? _latestReleaseApiUrl = Environment.GetEnvironmentVariable("TWEAKIVO_UPDATE_API_URL");
    private readonly string? _latestReleaseDownloadUrl = Environment.GetEnvironmentVariable("TWEAKIVO_UPDATE_DOWNLOAD_URL");
