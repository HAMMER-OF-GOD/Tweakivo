...
public partial class UpdateCheckViewModel : ObservableObject, IDisposable
{
    ...
    private void RefreshUpdateInfoBarText()
    {
        ...
        var message = _localizationService.GetString("Dialog_Update_Message") ?? "Good news! A new version of Tweakivo is available.";
            ...
            UpdateInfoBarMessage = _localizationService.GetString("Dialog_Update_NoUpdates_Message") ?? "You have the latest version of Tweakivo.";
                break;
        ...
        UpdateInfoBarMessage = _localizationService.GetString("Dialog_Update_Installed_Message") ?? "The update has been downloaded. Click Relaunch to install and restart Tweakivo.";
                break;
        }
    }
}
