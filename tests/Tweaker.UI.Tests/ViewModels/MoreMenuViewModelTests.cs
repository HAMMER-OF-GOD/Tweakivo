...
public class MoreMenuViewModelTests
{
    ...
    public void Constructor_InitializesVersionInfo_WithVersionFromService()
    {
        ...
        vm.VersionInfo.Should().Be("Tweakivo v25.06.01");
    }

    [Fact]
    public void Constructor_WhenVersionServiceThrows_DefaultsToTweakivo()
    {
        _mockVersionService
            .Setup(v => v.GetCurrentVersion())
        ...
        vm.VersionInfo.Should().Be("Tweakivo");
    }
    ...
    public void VersionInfo_Set_RaisesPropertyChanged()
    {
        ...
        vm.VersionInfo = "Tweakivo v99.0.0";

        raised.Should().BeTrue();
        vm.VersionInfo.Should().Be("Tweakivo v99.0.0");
    }
