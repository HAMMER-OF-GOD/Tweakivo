...
public class MainWindowViewModelTests : IDisposable
{
    ...
    public void Constructor_InitializesDefaultProperties()
    {
        ...
        sut.AppIconSource.Should().Be("ms-appx:///Assets/AppIcons/tweakivo-mark.png");
        sut.VersionInfo.Should().Be("Tweakivo");
    ...
    public void Initialize_SetsVersionInfo()
    {
        ...
        sut.VersionInfo.Should().Be("Tweakivo v25.05.01");
    }
    ...
    {
        var sut = CreateSut();
        sut.AppTitle.Should().Be("Tweakivo");
    }
